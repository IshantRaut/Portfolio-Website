...
const About = () => {
  ...
  Ishant
            ...
            <div className="flex justify-center">
              ...
              <a
                href="#projects"
                className="ml-4 inline-flex text-gray-300 bg-gray-800 border border-gray-600 py-2 px-6 focus:outline-none hover:bg-gray-700 rounded-full text-lg transition duration-300"
              >
                See My Projects
              </a>
            </div>
